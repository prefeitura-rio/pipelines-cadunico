...
SELECT
    ...
    CASE
        ...
        ELSE CAST( ind_snas_enfrenta_violencia_crianca_fam  AS STRING)
    END AS snas_enfrenta_violencia_crianca,
    CASE
        WHEN REGEXP_CONTAINS(ind_snas_acomp_social_liberdade_fam, r'^\s*$') THEN NULL
        ELSE CAST( ind_snas_acomp_social_liberdade_fam  AS STRING)
    ...
    CASE
        ...
        ELSE CAST( ind_snas_acomp_social_liberdade_comunidade_fam  AS STRING)
