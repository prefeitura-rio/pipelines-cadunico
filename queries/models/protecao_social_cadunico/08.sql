...
FROM `rj-smas.protecao_social_cadunico_versao.08_0601`
...
SELECT
    ...
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_versao.08_0603`
...
SELECT
    ...
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_versao.08_0604`
...
SELECT
    ...
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_versao.08_0609`
...
SELECT
    ...
    CAST(val_outras_rendas_memb AS STRING) AS val_outras_rendas_memb,
    CAST(ind_val_outras_rendas_memb AS STRING) AS ind_val_outras_rendas_memb,
    CAST(cod_orgm_vlr_rndmo_mes_passado AS STRING) AS cod_orgm_vlr_rndmo_mes_passado,
    CAST(cod_orgm_vlr_rndmo_bruto_prdo AS STRING) AS cod_orgm_vlr_rndmo_bruto_prdo,
    CAST(cod_origem_valor_ajuda_doacao AS STRING) AS cod_origem_valor_ajuda_doacao,
    CAST(cod_origem_valor_aposentadoria AS STRING) AS cod_origem_valor_aposentadoria,
    CAST(cod_orgm_vlr_seguro_desemprego AS STRING) AS cod_orgm_vlr_seguro_desemprego,
    CAST(cod_orgm_vlr_pensao_ali AS STRING) AS cod_orgm_vlr_pensao_ali,
    CAST(cod_orgm_vlr_outra_fonte_renda AS STRING) AS cod_orgm_vlr_outra_fonte_renda,
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_versao.08_0612`
