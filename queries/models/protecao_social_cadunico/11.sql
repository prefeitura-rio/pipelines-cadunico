...
SELECT
    ...
    SUBSTRING(text,47,1) AS ind_sesan_partic_alim_nutrição_fam,
    SUBSTRING(text,48,1) AS ind_sesan_capit_água_chuva_prod_alim_fam,
    ...
    SUBSTRING(text,56,1) AS ind_min_energ_elet_doação_fam,
    ...
    SUBSTRING(text,87,1) AS ind_snas_abrigo_criança_adoles_fam,
    ...
    SUBSTRING(text,99,1) AS ind_snas_orientação_especial_crianças_adol_fam,
