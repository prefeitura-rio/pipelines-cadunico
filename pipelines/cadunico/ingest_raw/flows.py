...
with Flow(
    ...
    with case(need_to_ingest_bool, True):
        ...
        with case(materialize_after_dump, True):
            # # VERSION TABLES
            # dump_version_tables_to_materialize_parameters = get_dbt_models_to_materialize_task(
            #     dataset_id=dataset_id,
            #     table_id=table_id,
    ...
    #     # VERSION TABLES
    #     all_version_tables_to_materialize_parameters = get_dbt_models_to_materialize_task(
    #         dataset_id=dataset_id,
    #         table_id=table_id,
    #         only_version_tables=True,
    #         first_execution=True,
    ...
    #     # PROD TABLES
    #     all_prod_tables_to_materialize_parameters = get_dbt_models_to_materialize_task(
    #         dataset_id=dataset_id,
    #         table_id=table_id,
    #         only_version_tables=False,
    #         first_execution=True,
