SELECT
  ...
  CASE
      WHEN d.id_calcamento_domicilio = '1' THEN 'Total'
      WHEN d.id_calcamento_domicilio = '2' THEN 'Parcial'
      WHEN d.id_calcamento_domicilio = '3' THEN 'Não existe'
      ELSE 'Não especificado'
  END AS calcamento_pavimentacao,
...
GROUP BY f.data_particao,  f.id_cras_creas, d.id_calcamento_domicilio
