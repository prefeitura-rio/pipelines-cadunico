...
FROM `rj-smas.protecao_social_cadunico_test_versao.escolaridade_test_0601_test`
...
SELECT
    ...
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_test_versao.escolaridade_test_0604_test`
...
SELECT
    ...
    SAFE_CAST(versao_layout_particao AS STRING) AS versao_layout_particao,
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-smas.protecao_social_cadunico_test_versao.escolaridade_test_0609_test`
