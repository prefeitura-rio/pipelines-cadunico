...
SELECT
    ...
    SUBSTRING(text,103,8) AS dt_intgo_vlr_rndmo_mes_passado,
    SUBSTRING(text,111,8) AS dt_intgo_vlr_rndmo_bruto,
    SUBSTRING(text,119,8) AS dt_intgo_vlr_aposentadoria,
    SUBSTRING(text,127,8) AS dt_intgo_vlr_outra_fonte_rnda,
